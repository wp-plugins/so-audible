...
jQuery.noConflict()(function(){
	...
	console.log(s3a('.soaudible').width());
	
	s3a('.soaudible').each(function(index){var s3username=s3a(this).data('username');var s3email=s3a(this).data('email');var s3bucket=s3a(this).data('bucket');var s3folder=s3a(this).data('folder');var dessoaudible='powered by <a href="http://soaudible.com/" target="_blank">soaudible</a>';var autoPlay=s3a(this).data('autoplay');if(autoPlay){var autoPlay=s3a(this).data('autoplay')}else{var autoPlay=false}false,s3a(this).html('<div id="jp_container_'+index+'"><div class="jp-type-playlist"><div id="jquery_jplayer_'+index+'" class="jp-jplayer"></div><div class="jp-gui"><div class="jp-video-play"><a href="javascript:;" class="jp-video-play-icon" tabindex="1">play</a></div><div class="jp-interface interfaceApp-'+index+'"><div class="jp-title-wrap"><div class="jp-title"><ul><li></li></ul></div></div><div class="jp-controls-holder"><ul class="jp-controls"><li><a href="javascript:;" class="jp-previous" tabindex="1">previous</a></li><li><a href="javascript:;" class="jp-play" tabindex="1">play</a><a href="javascript:;" class="jp-pause" tabindex="1">pause</a></li><li><a href="javascript:;" class="jp-next" tabindex="1">next</a></li><li><a href="javascript:;" class="jp-stop" tabindex="1">stop</a></li><li><a href="javascript:;" class="jp-mute" tabindex="1" title="mute">mute</a></li><li><a href="javascript:;" class="jp-unmute" tabindex="1" title="unmute">unmute</a></li><li><a href="javascript:;" class="jp-volume-max" tabindex="1" title="max volume">max volume</a></li></ul><div class="jp-volume-bar"><div class="jp-volume-bar-value"></div></div><ul class="jp-toggles"><li><a href="javascript:;" class="jp-shuffle" tabindex="1" title="shuffle">shuffle</a><a href="javascript:;" class="jp-shuffle-off" tabindex="1" title="shuffle off">shuffle off</a></li><li><a href="javascript:;" class="jp-repeat" tabindex="1" title="repeat">repeat</a></li><li><a href="javascript:;" class="jp-repeat-off" tabindex="1" title="repeat off">repeat off</a></li></ul></div><div class="jp-progress"><div class="jp-seek-bar"><div class="jp-play-bar"></div></div></div><div class="jp-current-time"></div><div class="jp-duration"></div></div></div><div class="s3desccenter s3desciption-'+index+'" style="display:none;">'+dessoaudible+'</div><div class="jp-playlist"><ul><li></li></ul></div><div class="jp-no-solution" style="display:none;"><span>Update Required</span>To play the media you will need to either update your browser to a recent version or update your <a href="http://get.adobe.com/flashplayer/" target="_blank">Flash plugin</a>.</div></div></div>');s3a(".interfaceApp-"+index).append("<div class='s3loadercenter s3loader-"+index+"'><img  src='https://s3-eu-west-1.amazonaws.com/isdcloud/ajax_loaders%2Fajax-loader-kit.gif' width='16' height='16'/></div>");var myPlaylist=new jPlayerPlaylist({jPlayer:"#jquery_jplayer_"+index,cssSelectorAncestor:"#jp_container_"+index},myPlaylist,{playlistOptions:{autoPlay:autoPlay,displayTime: 0,enableRemoveControls:false},swfPath:"http://s3.amazonaws.com/s3audible/",supplied:"mp3,m4a"});s3a.getJSON("http://data.s3audible.com/wp-plugin.php?username="+s3username+"&email="+s3email+"&bucket="+s3bucket+"&folder="+s3folder+"&filter=mp3|m4a&format=json&callback=?",function(playlist){myPlaylist.setPlaylist(playlist);s3a('.s3loader-'+index).hide();s3a('.s3desciption-'+index).fadeIn()})})
}); 